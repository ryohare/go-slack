...
import (
	...
	"github.com/ryohare/slack"
	"github.com/ryohare/slack/slackevents"
)
...
func TestSocketmodeHandler_Handle(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/ryohare/slack/socketmode.middleware",
		}, {
			...
			want: "github.com/ryohare/slack/socketmode.defaultmiddleware",
		},
	}
...
func TestSocketmodeHandler_HandleInteraction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/ryohare/slack/socketmode.middleware_interaction",
		}, {
...
func TestSocketmodeHandler_HandleEvents(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/ryohare/slack/socketmode.middleware_eventapi",
		}, {
			name: "Event do not Match any registered function",
			args: args{
				evt: Event{
...
func TestSocketmodeHandler_HandleInteractionBlockAction(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/ryohare/slack/socketmode.middleware_interaction_block_action",
		}, {
			name: "Event do not Match any registered function",
			args: args{
				evt: Event{
...
func TestSocketmodeHandler_HandleSlashCommand(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "github.com/ryohare/slack/socketmode.middleware_slach_command",
		}, {
			name: "Event do not Match any registered function",
			args: args{
				evt: Event{
